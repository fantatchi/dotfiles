...
- DADS デザイントークン正本（HEX 全量・タイポ・角丸・影）: `~/.agents/skills/spec-writer/references/dads-tokens.md`
- 用途別配色・状態色マッピング: `~/.agents/skills/spec-writer/references/visual-encoding.md`
```
