...
主要 HEX 値（[`dads-tokens.md`](dads-tokens.md) §2 から引用）:
...
- DADS デザイントークン正本（HEX 全量・タイポ・角丸・影）: `~/.claude/skills/spec-writer/references/dads-tokens.md`
- 用途別配色・状態色マッピング: `~/.claude/skills/spec-writer/references/visual-encoding.md`
```
