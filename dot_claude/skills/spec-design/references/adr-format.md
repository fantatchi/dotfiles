...
デフォルト系統 (**spec-design HTML 補足 = Vercel link blue `#0070f3`**) から別系統 (Blue 900 / Green / Orange / Light Blue / Cyan / Red 等) に切り替える場合、または業種的に複数案があり迷った場合に書く ADR。Nygard 形式の最小骨格:
...
- ベースカラー切替ルール: `~/.claude/skills/spec-design/references/base-color-mapping.md`
- パレット HEX 全量: `~/.claude/skills/spec-design/references/visual-encoding.md`
```
